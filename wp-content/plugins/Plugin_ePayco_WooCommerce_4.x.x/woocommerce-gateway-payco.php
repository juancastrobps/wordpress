...
var data={
    ...
    function theFunction () {
            handler.open(data)
                ...
                ',$this->epayco_publickey,$testMode,$descripcion, $descripcion, $order->get_id(),$currency,$order->get_total(),$tax,$base_tax,$basedCountry, $external, $redirect_url,$confirm_url,

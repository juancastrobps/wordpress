        ...
        <div style="clear: both; overflow: hidden;">
            ...
            <?php if (time() < strtotime('1st July 2020 14:00')): ?>
                <div style="float: right;">
                    <a href="https://currency-switcher.com/a/buy" title="Envato Mid Year Sale 2020 - 30-50% discount. Sale ends 1st July 2020!" target="_blank"><img height="60" src="<?php echo WOOCS_LINK ?>img/envato-mid-sale-2020.png" alt="" /></a>
                </div>
            <?php endif; ?>
        </div>
